...
import org.usfirst.frc6033.GearRobot2017.util.VisionData;
...
public class Robot extends IterativeRobot {
	...
	public static double AutoTurnSpeed = 0.45;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
		...
		autoChooser.addDefault("Center Peg", new AutoDeliverGearCenterPeg());
		autoChooser.addObject("Left Peg", new AutoDeliverGearLeftPeg());
		autoChooser.addObject("Right Peg", new AutoDeliverGearRightPeg());
		autoChooser.addObject("Stop", new DriveStop(0));
