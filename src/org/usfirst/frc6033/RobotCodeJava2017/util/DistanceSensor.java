package org.usfirst.frc6033.RobotCodeJava2017.util;
 ...
 * @author 708
 */
public abstract class DistanceSensor implements LiveWindowSendable {
	...
	public ITable getTable(ITable subtable) {
		m_table = subtable;
		updateTable();
		return m_table;
	}
