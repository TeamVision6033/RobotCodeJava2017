...
public class DriveStraight extends Command {
	...
	private double maxCoastDistance = 11.5;
	private double coastStep = 0.35;
	static final double Kp = 0.03;
	static final double decelDistance = 30;
	...
	public DriveStraight(double speed, double timeLimit, double distanceLimit, double stopAtDistance) {
	...
	protected void execute() {
		...
		Robot.drive.ArcadeDrive(-1 * calcSpeed,  -1 * (gyroAngle - initialAngle )* Kp, false); 
