 ...
 *
 */
public class AutoDeliverGearCenterPeg extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public AutoDeliverGearCenterPeg() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	addSequential(new DriveStraight(Robot.AutoSpeed, 60, 96, 12));
    	...
    	addSequential(new DriveStraight(-Robot.AutoSpeed, 60, 96, 0));
